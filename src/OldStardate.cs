namespace Stardate
{
    ...
    public class OldStardate : IComparable<OldStardate>, IEquatable<OldStardate>, IFormattable
    {
        public static readonly OldStardate BrightChainBirthDay = new OldStardate(new DateTime(year: 2021, month: 6, day: 16, hour: 3, minute: 33, second: 33));

        private readonly double starDate;

        private readonly DateTime utcDate;

        public OldStardate(DateTime dateTime)
        {
